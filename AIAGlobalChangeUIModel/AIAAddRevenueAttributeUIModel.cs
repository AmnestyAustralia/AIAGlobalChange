...
namespace AIAGlobalChangeUIModel
{
    ...
    public partial class AIAAddRevenueAttributeUIModel
    {
        ...
        private void AIAAddRevenueAttributeUIModel_Loaded(object sender, Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs e)
        {
            IsMulticurrencyOn();
            CODETABLEVALUE.CodeTableName = null;
            RECORDTYPEID.Value = GlobalChangeHelper.GetRecordTypeID("REVENUE", GetRequestContext());
        ...
        private void AIAAddRevenueAttributeUIModel_BeginValidate(object sender, BeginValidateEventArgs e)
        {
...
#region "Event handlers"
        ...
        {
            this.Loaded += AIAAddRevenueAttributeUIModel_Loaded;
            this.BeginValidate += AIAAddRevenueAttributeUIModel_BeginValidate;
