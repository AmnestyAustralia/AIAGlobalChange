...
namespace AIAGlobalChangeUIModel
{
    ...
    public partial class AIADeleteRevenueAttributeUIModel
    {
        ...
        private void AIADeleteRevenueAttributeUIModel_Loaded(object sender, Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs e)
        {
            IsMulticurrencyOn();
...
#region "Event handlers"
        ...
        {
            this.Loaded += AIADeleteRevenueAttributeUIModel_Loaded;
